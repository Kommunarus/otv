...
def main(
    ...
    if not model:
        ...
        yolo_model.iou = iou
        yolo_model.agnostic = True  # kav 200922
    ...
    for video_file in video_files:
        ...
        if os.path.exists(dir_features):
            allf = os.listdir(dir_features)
            for f in allf:
                os.remove(os.path.join(dir_features, f))
        else:
        ...
        detections_video = yolo.detect_video(
            ...
            model_siam=model_siam, # kav 190922
            dir_features=dir_features # kav 111022
        )
